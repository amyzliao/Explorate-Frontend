<template>
    ...
    <h1
        ...
        Edit an NGO in the database</h1>
    <div className="big-form">
        ...
        <button v-on:click="editOpp" type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
            Save Edits
        </button>
    </div>
    <FooterMod/>
